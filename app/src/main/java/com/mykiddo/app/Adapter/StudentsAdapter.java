...
public class StudentsAdapter extends RecyclerView.Adapter<StudentsAdapter.PlaceViewHolder> {
    private Context mContext;
    private ArrayList<NotifyData> mModelList;
    ImaggListner imaggListner;


    public StudentsAdapter(Context mContext, ArrayList<NotifyData> mPlaceList, ImaggListner imaggListner) {
    ...
    public PlaceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_studens,
                parent, false);
