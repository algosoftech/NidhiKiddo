...
public class RouteTimeAdapter extends RecyclerView.Adapter<RouteTimeAdapter.PlaceViewHolder> {
    private Context mContext;
    private ArrayList<NotifyData> mModelList;
    ImaggListner imaggListner;


    public RouteTimeAdapter(Context mContext, ArrayList<NotifyData> mPlaceList, ImaggListner imaggListner) {
    ...
    public PlaceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_route_timings,
                parent, false);
    ...
    public class PlaceViewHolder extends RecyclerView.ViewHolder {
        ...
        public PlaceViewHolder(View itemView) {
            ...
            ttxt = itemView.findViewById(R.id.s_no);
            text = itemView.findViewById(R.id.location);
